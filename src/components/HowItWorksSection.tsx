      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            ...
            >
             <div className={`absolute -top-4 -left-4 ${readingMode ? 'bg-black text-white !text-white' : 'bg-cre8-purple text-black'} font-silkscreen font-bold py-1 px-3 rounded-md`}>
