    ...
    <section className="py-20 bg-[#07080F] relative" id="about">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto font-doto">
        ...
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-cre8-purple mb-6">What is CRE8TAR?</h3>
          <p className="text-gray-300 mb-6">
            CRE8TAR is more than an assistant—it's a sentient digital presence. Your avatar doesn't just hear what you say—it understands how you feel. 
            CRE8TAR uses emotional intelligence to create personalized experiences that evolve with you.
          </p>
          <p className="text-gray-300">
            Whether you're looking for motivation, support, or creativity, your avatar adjusts to become what you need, when you need it. 
