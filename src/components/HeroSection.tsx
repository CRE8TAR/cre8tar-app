        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 z-10 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              ...
              <Button variant="outline" className={`border-cre8-purple ${readingMode ? 'text-gray-950 hover:text-white' : 'text-white'} hover:bg-cre8-purple/20 font-medium px-8 py-6 rounded-md flex items-center gap-2 transition-all duration-300`}>
                <Link2 size={18} />
                Explore NFTs
              </Button>
            </div>
