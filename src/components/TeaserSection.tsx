      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <ScrollTypingEffect
            ...
            tag="p"
            className="text-gray-300 font-doto max-w-3xl mx-auto"
            delay={40}
          />
        </div>
        
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#0A0C14] border border-[#1A1D2E] rounded-xl p-8 flex flex-col items-center hover:shadow-[0_0_30px_rgba(155,135,245,0.25)] transition-all duration-500 hover:scale-[1.02] transform-gpu">
            <div className="bg-gradient-to-r from-cre8-neon-blue/20 to-cre8-neon-pink/20 w-full aspect-video rounded-lg flex items-center justify-center mb-6 hover:from-cre8-neon-blue/30 hover:to-cre8-neon-pink/30 transition-all duration-500">
